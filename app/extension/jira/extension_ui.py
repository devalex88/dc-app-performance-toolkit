...
def create_issue(webdriver, dataset):
    ...
    @print_timing("selenium_custom_action_create_issue")
    def measure():

        @print_timing("selenium_custom_action_create_issue:open_quick_create")
        def sub_measure():
        ...
        def sub_measure():
            ...
            @print_timing("selenium_custom_action_create_issue:fill_and_submit_issue_form:submit_issue_form")
            def sub_sub_measure():
