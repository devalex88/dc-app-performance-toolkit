...
def create_issue(webdriver, dataset):
    ...
    @print_timing("katalon_create_bdd_issue")
    def measure():

        @print_timing("katalon_create_bdd_issue:open_quick_create")
        def sub_measure():
            issue_modal.open_create_issue_modal()
        sub_measure()

        @print_timing("katalon_create_bdd_issue:fill_and_submit_issue_form")
        def sub_measure():
            ...
            @print_timing("katalon_create_bdd_issue:fill_and_submit_issue_form:submit_issue_form")
            def sub_sub_measure():
...
def view_issue(webdriver, datasets):
    ...
    @print_timing("katalon_view_bdd_issue")
    def measure():
        issue_page.go_to()
